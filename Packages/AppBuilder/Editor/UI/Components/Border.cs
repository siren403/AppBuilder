...
namespace AppBuilder.UI
{
    ...
    public class Border : ImmediateModeElement, IDisposable
    {
        Material m_Mat;
        ...
        void RecreateResources()
        {
            ...
            if (m_Mat == null)
                m_Mat = new Material(Shader.Find("Hidden/AppBuilder/GradientBorder"));
        }
        ...
        public new class UxmlFactory : UxmlFactory<Border>
        {
        }
    }
}